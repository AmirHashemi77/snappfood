    ...
    return (
        <div className={style.container}>
            <div className={style.imageContainer}>
                ...
                <img className={style.restrantLogo} src="/images/test2.jpeg" alt="" />
                


            </div>
            <div className={style.decription}>
                <h4 className={style.title}>آش و حلیم حاج مهدی</h4>
                <div className={style.rateSection}>
                        ...
                        <span className={style.score}>۴.۳</span>
                        <span className={style.number}>(۱۱۰۰)</span>
                </div>
                <p className={style.subtitle}>ایرانی ، سنتی ، پیش غذا</p>
