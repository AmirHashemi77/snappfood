...
import style from './foodsCartItem.module.scss';
import { useDispatch } from 'react-redux';
import { cartSliceAction } from '../../Store/Slice/cartSlice/cartSlice';
const FoodsCartItem = ({id,title,price,quantity}) => {
    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.priceAndNum}>
                <p className={style.price}><span>{price}</span>تومان</p>
                <div className={style.buttons}>
                                        ...
                                        <p className={style.num}>{quantity}</p>
